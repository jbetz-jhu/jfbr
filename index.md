...
Convenience functions have been added for the
...
The default for
[`table1::table1()`](https://rdrr.io/pkg/table1/man/table1.html) is to
produce Mean (SD) and Median \[Min, Max\] for numeric values, and `NA`
is treated as a level of a factor for categorical variables.

**Note: saving the result of
[`table1::table1()`](https://rdrr.io/pkg/table1/man/table1.html) and
using [`knitr::kable()`](https://rdrr.io/pkg/knitr/man/kable.html)is
only necessary when HTML output is not possible
...
| continuous |  |  |  |
| Mean (SD) | 0.525 (0.297) | 0.560 (0.291) | 0.543 (0.294) |
| Median \[IQR\] | 0.510 \[0.294, 0.757\] | 0.601 \[0.317, 0.811\] | 0.588 \[0.306, 0.795\] |
| \[Min, Max\] | \[0.00114, 0.993\] | \[0.00599, 0.990\] | \[0.00114, 0.993\] |
| Missing | 0 (0%) | 1 (1.0%) | 1 (0.5%) |
| numbers |  |  |  |
| Mean (SD) | 100 (57.0) | 101 (59.0) | 101 (57.9) |
| Median \[IQR\] | 100 \[56.0, 146\] | 104 \[49.5, 154\] | 101 \[51.5, 151\] |
| \[Min, Max\] | \[1.00, 200\] | \[2.00, 197\] | \[1.00, 200\] |
| Missing | 0 (0%) | 1 (1.0%) | 1 (0.5%) |
...
| continuous |               |               |               |
| Mean (SD)  | 0.525 (0.297) | 0.560 (0.291) | 0.543 (0.294) |
| 5%, 95%    | 0.0343, 0.967 | 0.0900, 0.964 | 0.0544, 0.966 |
| Missing    | 0 (0%)        | 1 (1.0%)      | 1 (0.5%)      |
| numbers    |               |               |               |
| Mean (SD)  | 100 (57.0)    | 101 (59.0)    | 101 (57.9)    |
| 5%, 95%    | 10.2, 189     | 12.1, 190     | 10.9, 190     |
| Missing    | 0 (0%)        | 1 (1.0%)      | 1 (0.5%)      |
