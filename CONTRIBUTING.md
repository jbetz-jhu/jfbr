# Contributing to jfbr

This outlines how to propose a change to jfbr. For a detailed discussion
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("jbetz-jhu/jfbr", fork = TRUE)`.
...
Please note that the jfbr project is released with a [Contributor Code
of Conduct](https://jbetz-jhu.github.io/jfbr/CODE_OF_CONDUCT.md). By
