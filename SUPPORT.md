...
Thanks for using jfbr! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/jbetz-jhu/jfbr/issues/new).
...
requests](https://github.com/jbetz-jhu/jfbr/issues) to make sure the bug
